...
class Employee(models.Model):
    ...
    def register_face(self, image_data):
        try:
            ...
            if hasattr(self, '_processing_face_registration') and self._processing_face_registration:
                return
                
            # Set flag to prevent recursion
            self._processing_face_registration = True
            ...
            # Reset flag
            if hasattr(self, '_processing_face_registration'):
                self._processing_face_registration = False