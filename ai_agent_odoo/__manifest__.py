{
    ...
    'description': """
        ...
        allowing users to ask questions and trigger actions within Odoo. The assistant can
        access local Odoo data (partners, products, sale orders) to provide accurate and
