  ...
  async update_record_sets(recordId, chart_type, isDirty, name, data) {
    try {
      ...
      if (
        ...
        recordSets.type === "error"
      ) {
        console.error("Chart data error:", recordSets.message);
        this.state.isKpiError = true;
        this.state.recordSets = { 
          type: "error", 
          message: recordSets.message || "An error occurred while loading chart data" 
        };
      } else if (
      ...
      console.error("Error updating record sets:", error);
      this.state.isKpiError = true;
      this.state.recordSets = { 
        type: "error", 
